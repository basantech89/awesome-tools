...
import { Button, buttonVariants } from '@awesome-tools/ui'
import {
	ChevronDownIcon,
	ChevronLeftIcon,
	ChevronRightIcon
...
type CalendarComponent<Props> = (props: Props) => React.JSX.Element

const CalendarContext = React.createContext<{
	locale?: Partial<Locale>
}>({})

const CalendarRoot: CalendarComponent<RootProps> = ({
	className,
	rootRef,
	...props
}) => (
...
const CalendarChevron: CalendarComponent<ChevronProps> = ({
	className,
	orientation,
	...props
}) => {
...
const CalendarWeekNumber: CalendarComponent<WeekNumberProps> = ({
	children,
	scope: _scope,
	...props
}) => (
...
function Calendar({
	...
	const defaultClassNames = getDefaultClassNames()
	const calendarContextValue = React.useMemo(() => ({ locale }), [locale])

	return (
		<CalendarContext value={calendarContextValue}>
			<DayPicker
