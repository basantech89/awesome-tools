import type { AuthProvider } from '#blocks'
...
const GoogleIcon = () => (
	...
	>
		...
		<g mask="url(#mask0_17_40)">
			...
			<g filter="url(#filter8_f_17_40)" opacity="0.5">
				<path
...
const MetaIcon = () => (
	<svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 171">
...
const AppleIcon = () => (
	<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		<title>Proceed with Apple</title>
		<path
...
export const icons: Record<AuthProvider, React.ReactNode> = {
	google: <GoogleIcon />,
	meta: <MetaIcon />,
	apple: <AppleIcon />,
	github: <GithubIcon />,
